...
class LevelCompletedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    LevelCompletedViewModel _viewModel =
        context.read<LevelCompletedViewModel>();
    LevelCompletedViewModelState _state = _viewModel.state;
                    ...
                    IconButton(
                      onPressed: () {
                        ...
                        if (_state.isEndGame) {
                          ...
                          try {
                            String _nextLevelId = _state.nextLevelId;
